...
// Events are also mirrored to the Node.js backend (fire-and-forget).
import { postEvent } from "./api";

export type Skill = "balance" | "coordination" | "bodyAwareness" | "vocabulary" | "numeracy";
